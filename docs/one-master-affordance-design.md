...
- **Scope set to "system principle + Phone deep build + 1–2 sketches"** rather than full multi-app CarPlay redesign. Full redesign was honestly months of work risking nothing finished to portfolio standard. Current scope is ambitious in argument, finishable in artifact.
